...
const aeropuertos = [
  ...
  { codigo: 'LIR', nombre: 'La Unión', pais: 'El Salvador' },
];
    ...
    <form
      ...
      className={`${
        isHero
          ...
          : 'bg-white rounded-xl shadow-sm p-4 md:p-6 border'
      }`}
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
        ...
        <div className="md:col-span-3">
          <label className="block text-sm font-semibold text-gray-700 mb-2">
            <FiMapPin className="inline mr-1" /> Origen
          </label>
          <select
            name="origen"
            value={form.origen}
        ...
        <div className="md:col-span-1 flex justify-center">
          <button
            ...
            className="w-10 h-10 bg-primary-50 hover:bg-primary-100 text-primary-600 rounded-full flex items-center justify-center transition-all hover:rotate-180 duration-300"
            title="Intercambiar"
          >
        ...
        <div className="md:col-span-3">
          <label className="block text-sm font-semibold text-gray-700 mb-2">
            <FiMapPin className="inline mr-1" /> Destino
          </label>
          <select
            name="destino"
            value={form.destino}
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-semibold text-gray-700 mb-2">
            <FiCalendar className="inline mr-1" /> Fecha
          </label>
          <input
            type="date"
            name="fecha"
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-semibold text-gray-700 mb-2">
            <FiUsers className="inline mr-1" /> Pasajeros
          </label>
          <select
            name="pasajeros"
      ...
      <div className="mt-4 pt-4 border-t flex flex-wrap gap-4 items-center">
        <label className="flex items-center space-x-2 cursor-pointer">
          <input
            type="checkbox"
            checked={form.soloIda}
            onChange={(e) => setForm({ ...form, soloIda: e.target.checked })}
